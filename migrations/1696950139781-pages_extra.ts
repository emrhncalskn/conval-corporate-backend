...
export class PagesExtra1696950139781 implements MigrationInterface {
    name = 'PagesExtra1696950139781'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_a3ffb1c0c8416b9fc6f907b7433\` FOREIGN KEY (\`id\`) REFERENCES \`pages_extra\`(\`author_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
